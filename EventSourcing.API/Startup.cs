...
namespace EventSourcing.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IEventSourcingProducerRepository, EventSourcingProducerRepository>();
            services.AddScoped<IEventSourcingConsumerRepository, EventSourcingConsumerRepository>();
